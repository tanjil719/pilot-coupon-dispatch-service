...
// Owner-facing view. Never exposes reviewedBy or any other admin metadata beyond the rejection
// reason (see BookingAdminResponse for the admin equivalent).
@NoArgsConstructor
@AllArgsConstructor
@Getter
@Setter
public class BookingResponse implements Serializable {
    ...
    @JsonFormat(pattern = "dd-MM-yyyy HH:mm:ss")
    private LocalDateTime approximateServiceEnd;
